...
class DatabaseConfig:
    ...
    @staticmethod
    def save_config(config: Dict[str, str], config_file: str = 'database_config.json'):
    ...
    @staticmethod
    def load_config(config_file: str = 'database_config.json') -> Dict[str, str]:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config-file', default='database_config.json', help='Configuration file path')
